...
using namespace std;
int main () {
double input1 = 65;//double input1 and initialize it with 65
double input2 = 23;//double input2 and initialize it with 23
double minimumValue = fmin(input1, input2); //double minimumValue (lower inputted value)
double maximumValue=fmax(input1,input2); //double maximumValue (higher inputted value
